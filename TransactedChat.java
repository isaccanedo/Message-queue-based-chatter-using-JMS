...
public class TransactedChat {
  ...
  public static void main(String[] args) {
    ...
    try {/*from www .  j a v  a 2  s  . c  o m*/
      // start up an init context... properties file must be named "jndi.properties"
      // on the root
      // of the classpath
      ...
      System.out.println("The application user " + chatter + " connects to the broker.\n"
          + "The application will stage messages to the " + destination.toString()
      ...
      // start the connection AFTER the sout because if there are pending messages
      // they would get printed
